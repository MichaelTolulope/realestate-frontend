...
const AdminSideNav = ({ setPage }) => {
  ...
  return (
    <div className={`relative bg-transparent py-3 flex flex-col gap-5 justify-between overflow-hidden hover:w-[290px] hover:min-w-[290px] transition-all ${checked ? 'w-[290px]' : 'w-[70px]'}`} >
      <div>
