          ...
          <div className="max-w-xl lg:max-w-3xl">
            ...
            >
              {({
                ...
                <form action="#" className="mt-8 grid grid-cols-6 gap-6 rounded-lg shadow-md px-20 py-24 " onSubmit={handleSubmit}>
                  ...
                  <div className="col-span-6 ">
                    ...
                    <input
                      ...
                      className="mt-1 w-full rounded-md border-gray-200 bg-white text-md text-gray-700 shadow-sm  p-3 focus:outline-none focus:ring  transition"
                    />
                  </div>
