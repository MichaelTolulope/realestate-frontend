              ...
              {({
                ...
                <form className="mt-8 grid grid-cols-6 gap-6" onSubmit={handleSubmit}>
                  ...
                  <div className="col-span-6">
                    <label htmlFor="MarketingAccept" className="flex gap-4">
                      <input
                        ...
                        className="size-5 rounded-md border-gray-200 bg-white shadow-sm p-3 focus:outline-none focus:ring transition"
                      />
                  ...
                  <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
                    <button
                      type='submit'
                      className=" inline-block shrink-0 rounded-2xl border border-black bg-black px-12 py-3 text-sm font-medium text-white transition hover:bg-transparent hover:text-black focus:outline-none focus:ring-black active:text-black"
                    >
                      Create an account
                    </button>
